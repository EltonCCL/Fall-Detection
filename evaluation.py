...
UR_FALL_INFERENCE = "inference_result/UR_FALL.json"
MULTI_CAM_INFERENCE = "inference_result/multi_cam.json"
LE2I_INFERENCE = "inference_result/le2i.json"
...
def le2i():
    ...
    with open("LE2I_EVAL.json", "w") as outfile:
...
def ur_fall():
    ...
    stat_data = result.get_dict()
    print(stat_data["score"])
    with open("UR_FALL_EVAL.json", "w") as outfile:
        json.dump(stat_data, outfile)
